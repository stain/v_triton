...
- extended PNG support (via Libpng 1.2.12 and Zlib 1.2.3)
...
together with IJG JPEG library 6b, Libpng 1.2.12, Zlib 1.2.3, Libtiff 3.8.2,
...
The source package ships with full source code of Libpng 1.2.12 and Zlib 1.2.3.
